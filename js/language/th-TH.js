...
window.calendar_languages['th-TH'] = {
	...
	error_where: 'ปฏิทิน: Wrong navigation direction {0}. Can be only "next" or "prev" or "today"',
	error_timedevide: 'ปฏิทิน: Time split parameter should divide 60 without decimals. Something like 10, 15, 30',
